  ...
  const categories: TourCategory[] = [
    {
      ...
      scenes: {
        exterior: {
          ...
          imagePath: '/panorama/rumah_tampak_depan.png',
          ...
          info: {
            ...
            description: 'Fasad luar unit subsidi perumahan Bumi Pasanggrahan dengan gaya arsitektur modern minimalis. Sudah dilengkapi dengan area carport beton, taman depan asri, sirkulasi udara yang luas, dan struktur kokoh dinding dobel bata merah.'
          }
        },
        ruang_tamu: {
          id: 'ruang_tamu',
          ...
          imagePath: '/panorama/ruang_tamu.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [0, -20, 100],
          ...
          info: {
            ...
            area: '10.5 m²',
            description: 'Area ruang tamu & ruang keluarga yang fungsional dengan pencahayaan alami yang melimpah dari jendela depan. Layout yang dinamis memudahkan penataan sofa dan meja keluarga minimalis sesuai kebutuhan.'
          }
        },
        kamar_utama: {
          id: 'kamar_utama',
          ...
          imagePath: '/panorama/kamar_utama.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [0, -20, 100],
          ...
          info: {
            ...
            dimensions: '3m x 3m',
            area: '9 m²',
            description: 'Kamar tidur utama yang dirancang lapang untuk penempatan kasur ukuran Queen (No. 2). Dilengkapi ventilasi udara horizontal untuk sirkulasi kamar yang sejuk dan menenangkan.'
          }
        },
        kamar_anak: {
          id: 'kamar_anak',
          ...
          imagePath: '/panorama/kamar_anak.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [0, -20, 100],
          ...
          info: {
            ...
            area: '7.5 m²',
            description: 'Kamar tidur sekunder yang sangat cocok untuk kamar anak atau ruang kerja pribadi. Tata letak ruang yang presisi mempermudah integrasi meja belajar, lemari, dan kasur single.'
          }
        },
        dapur: {
          id: 'dapur',
          ...
          info: {
            ...
            dimensions: '2m x 3m',
            area: '6 m²',
            description: 'Area dapur belakang semi-outdoor yang dirancang fungsional lengkap dengan wastafel cuci piring dan meja beton cor. Menjamin asap dapur mengalir langsung ke luar ruangan untuk sirkulasi rumah yang sehat.'
          }
        },
        wc: {
          id: 'wc',
          ...
          info: {
            ...
            area: '2.25 m²',
            description: 'Kamar mandi modern bernuansa bersih dengan kloset jongkok/duduk, dilapisi lantai keramik antislip bermutu tinggi demi kenyamanan sirkulasi sanitasi keluarga.'
          }
        }
      }
    },
      ...
      scenes: {
        exterior: {
          ...
          info: {
            ...
            description: 'Tampilan luar unit premium tipe komersil Bumi Pasanggrahan dengan fasad modern kontemporer yang elegan. Dilengkapi dengan carport berukuran besar (muat hingga 2 mobil), taman depan minimalis, dan finishing cat dinding premium tahan cuaca.'
          }
        },
        teras: {
          id: 'teras',
          ...
          info: {
            ...
            dimensions: '2.5m x 3m',
            area: '7.5 m²',
            description: 'Teras depan yang representatif dengan lantai ubin granit berkelas, memberikan kesan penyambutan mewah sebelum melangkah masuk ke dalam hunian utama.'
          }
        },
        ruang_tamu: {
          id: 'ruang_tamu',
          ...
          info: {
            ...
            dimensions: '4m x 4m',
            area: '16 m²',
            description: 'Ruang tamu eksklusif berplafon tinggi (high ceiling) yang dirancang untuk menciptakan sirkulasi udara optimal dan pencahayaan yang merata, melambangkan kemewahan tinggal di cluster komersil.'
          }
        },
        ruang_tengah: {
          id: 'ruang_tengah',
          ...
          info: {
            ...
            dimensions: '4m x 5m',
            area: '20 m²',
            description: 'Ruang keluarga tengah berdimensi lapang sebagai sentral aktivitas berkumpul, bersantai, dan berinteraksi. Sangat cocok ditempatkan home theater set atau meja makan keluarga besar.'
          }
        },
        dapur: {
          id: 'dapur',
          ...
          info: {
            ...
            dimensions: '3m x 3m',
            area: '9 m²',
            description: 'Dapur dalam berdesain modern minimalis, ditunjang dengan meja counter beton lapis granit hitam. Memiliki instalasi pipa air bersih yang andal dan space khusus kulkas besar.'
          }
        }
      }
    },
    {
      ...
      scenes: {
        exterior: {
          ...
          imagePath: '/panorama/Scene 74.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [-200, -8, -30],
          ...
          info: {
            ...
            area: '225 m²',
            description: 'Halaman depan Masjid Jami Al-Muhajirin yang bersih dan asri, dilengkapi dengan area parkir kendaraan, taman kecil, dan tempat wudhu luar ruangan yang higienis.'
          }
        },
        interior: {
          id: 'interior',
          ...
          imagePath: '/panorama/Scene 75.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [0, -20, 100],
          ...
          info: {
            ...
            area: '144 m²',
            description: 'Ruang dalam ibadah utama shalat berjamaah. Desain interior bernuansa islami modern dengan karpet sajadah tebal dan wangi, serta pencahayaan lampu gantung yang tenang dan teduh.'
          }
        }
      }
    },
    {
      ...
      scenes: {
        playground: {
          ...
          imagePath: '/panorama/Scene 44.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [-200, -8, -30],
          ...
          info: {
            ...
            area: '600 m²',
            description: 'Ruang Terbuka Hijau (RTH) yang berlokasi strategis di tengah cluster. Dilengkapi dengan wahana ayunan, perosotan anak, jalur pijat refleksi kaki, serta gazebo kayu untuk tempat berteduh warga cluster.'
          }
        },
        jalan: {
          id: 'jalan',
          ...
          imagePath: '/panorama/Scene 70.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [0, -20, 100],
          ...
          info: {
            ...
            description: 'Jalur row jalan utama perumahan yang lebar dan dicor beton kualitas tinggi, bebas banjir dan muat berpapasan 2 mobil dengan leluasa. Dilengkapi dengan jalur drainase tertutup di samping kiri-kanan jalan.'
          }
        },
        gerbang: {
          id: 'gerbang',
          ...
          imagePath: '/panorama/Scene 72.png',
          initialRotation: 0,
          hotspots: [
            {
              position: [0, -20, 100],
          ...
          info: {
            ...
            description: 'Gerbang masuk utama perumahan Bumi Pasanggrahan dengan One Gate System (Sistem Satu Pintu). Dilengkapi pos penjagaan satpam 24 jam penuh untuk menjamin keamanan optimal seluruh penghuni perumahan.'
          }
        }
      }
    }
